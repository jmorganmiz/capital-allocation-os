...
test('real-OM benchmark fails closed before external document processing', () => {
  ...
  assert.match(script, /actualAssetType/)
  assert.match(script, /extraction\.warnings/)
  assert.match(script, /extractedFactCount/)
  assert.match(script, /totals\.citations \/ totals\.facts/)
