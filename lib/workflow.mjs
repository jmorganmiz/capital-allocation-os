...
export function getAccessState({ trialEndsAt, subscriptionStatus, compAccess = false, now = Date.now() }) {
  ...
  const comp = Boolean(compAccess)
  return {
    subscribed,
    trialActive,
    compAccess: comp,
    allowed: comp || subscribed || trialActive,
